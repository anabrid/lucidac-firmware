...
functions::SR74HCT595 switcher_shift_reg{
    bus::idx_to_addr(0, bus::C_BLOCK_IDX, blocks::CBlock::SCALE_SWITCHER)};
...
void test_address() { TEST_ASSERT_EQUAL(0b100001'0010, switcher_shift_reg.address); }
