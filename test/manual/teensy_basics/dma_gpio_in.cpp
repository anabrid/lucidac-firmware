...
// All are configured with INPUT_PULLDOWN, giving you a buffer filled with zeros at those pin positions (bit
// 19-26). Pull one of the pins high to see some data at bits 19-26 in the DMA buffer.
