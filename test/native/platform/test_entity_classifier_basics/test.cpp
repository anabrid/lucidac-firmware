...
void test_cblock_v1_variants() {
  CBlockHAL_V_1_1_X cblock_seq(bus::idx_to_addr(0, CBlock::BLOCK_IDX, 0));
  ...
  CBlockHAL_V_1_0_X cblock_mixed(bus::idx_to_addr(0, CBlock::BLOCK_IDX, 0));
...
void test_cblock_from_entity_classifier() {
  auto cblock_unknown =
      CBlock::from_entity_classifier(EntityClassifier(CBlock::CLASS_, CBlock::TYPE, Version{0}, 0),
                                     bus::idx_to_addr(0, CBlock::BLOCK_IDX, 0));
  TEST_ASSERT_EQUAL(nullptr, cblock_unknown);

  auto cblock_seq =
      CBlock::from_entity_classifier(EntityClassifier{CBlock::CLASS_, CBlock::TYPE, Version{1, 1, 0}, 1},
                                     bus::idx_to_addr(0, CBlock::BLOCK_IDX, 0));
  TEST_ASSERT_NOT_EQUAL(nullptr, cblock_seq);
  TEST_ASSERT_TRUE(dynamic_cast<CBlockHAL_V_1_1_X *>(cblock_seq->hardware));
  TEST_ASSERT_FALSE(dynamic_cast<CBlockHAL_V_1_0_X *>(cblock_seq->hardware));

  auto cblock_mixed =
      CBlock::from_entity_classifier(EntityClassifier{CBlock::CLASS_, CBlock::TYPE, Version{1, 0, 0}, 1},
                                     bus::idx_to_addr(0, CBlock::BLOCK_IDX, 0));
  TEST_ASSERT_NOT_EQUAL(nullptr, cblock_mixed);
  TEST_ASSERT_FALSE(dynamic_cast<CBlockHAL_V_1_1_X *>(cblock_mixed->hardware));
  TEST_ASSERT_TRUE(dynamic_cast<CBlockHAL_V_1_0_X *>(cblock_mixed->hardware));
}

void test_mblock_from_entity_classifier() {
  auto unknown_mblock = MBlock::from_entity_classifier(
      EntityClassifier{EntityClass::M_BLOCK, static_cast<const uint8_t>(MBlock::TYPES::UNKNOWN), Version{0},
                       0},
  ...
  auto m_int8_block = MBlock::from_entity_classifier(
      EntityClassifier{EntityClass::M_BLOCK, static_cast<const uint8_t>(MBlock::TYPES::M_INT8_BLOCK),
                       Version{1, 0, 0}, 1},
      bus::idx_to_addr(0, MBlock::M0_IDX, 0));
