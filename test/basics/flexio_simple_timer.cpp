...
void setup() {
    ...
    */
    ...
    flexio->setClockSettings(1 /* PLL3 480Mhz base */, 1 /* first divide by 1+1=2 */, 3 /* second divide by 3+1=4 */);
    ...
    // TIMOD
    flexio->port().TIMCTL[_timer] = FLEXIO_TIMCTL_TRGPOL | FLEXIO_TIMCTL_PINCFG(3) | FLEXIO_TIMCTL_PINSEL(_sck_flex_pin) |
