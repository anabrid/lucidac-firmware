...
void test_dac_adc() {
    ...
    std::cout << "DAC0 input: " << val0 << ", Raw output: " << channels_raw[0] << " ADC0 output: " << measured_val0 << std::endl;
    std::cout << "DAC1 input: " << val1 << ", Raw output: " << channels_raw[1] << " ACD1 output: " << measured_val1 << std::endl;
