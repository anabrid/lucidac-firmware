...
// As often, the chip expects SPI_MODE0, but some signals are inverted on the way
const SPISettings functions::AD8402::DEFAULT_SPI_SETTINGS{4'000'000, MSBFIRST, SPI_MODE3};
...
void functions::AD8402::write_ch0_resistance(float percent) {
  begin_communication();
