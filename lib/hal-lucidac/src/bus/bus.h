...
constexpr uint8_t M0_BLOCK_IDX = 4;
constexpr uint8_t M1_BLOCK_IDX = 5;
...
constexpr uint8_t M0_BLOCK_BADDR(uint8_t cluster_idx) { return BLOCK_BADDR(cluster_idx, M0_BLOCK_IDX); };
