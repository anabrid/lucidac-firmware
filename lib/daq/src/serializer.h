...
constexpr size_t IDX_MINUS_ONE = 200;
constexpr size_t IDX_ZERO = 1200;
constexpr size_t IDX_PLUS_ONE = 2200;

//mal FASTRUN austesten :)
constexpr std::array<char[7], 2401> normalized_to_float_str_arr = {
