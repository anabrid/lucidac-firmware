...
inline void convertToJson(const UUID &uuid, JsonVariant target) { uuid.toJson(target.to<JsonArray>()); }

inline void convertFromJson(JsonVariantConst src, UUID &uuid) { uuid.fromJson(src); }
